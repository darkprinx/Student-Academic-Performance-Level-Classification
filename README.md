...
* ***The whole visualization & analysis description can be found here [NOTEBOOK](https://github.com/darkprinx/Students-Academic-Performance-Level-Classification/blob/master/Mechine%20learning.ipynb 'notebook')*** 
